...
export default function SendWinnerLoseBracket4P(currentGameNum, roundNumber,w1,w2, bracketSpots, mode){
	var destGame;
	if (roundNumber % 2 == 0) {
	...
	this.SetPlayerInDestGame4P(currentGameNum, destGame, topGame, botGame, w1,w2);
}